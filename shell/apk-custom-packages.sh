...
# USB基础驱动
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-usb-storage kmod-usb-ohci kmod-usb-uhci kmod-usb2 kmod-usb3"
# 文件系统驱动（NTFS、EXT4、FAT32，日常硬盘全支持）
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-fs-ntfs3 kmod-fs-ext4 kmod-fs-vfat kmod-fs-msdos"
# 字符集，解决中文文件名乱码
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-nls-cp437 kmod-nls-iso8859-1 kmod-nls-utf8"
# 硬盘挂载工具 + 自动挂载
CUSTOM_PACKAGES="$CUSTOM_PACKAGES mountd block-mount luci-app-mountd luci-i18n-mountd-zh-cn"
# KSMBD SMB共享（Windows访问USB硬盘，推荐）
CUSTOM_PACKAGES="$CUSTOM_PACKAGES ksmbd luci-app-ksmbd luci-i18n-ksmbd-zh-cn"
